...
class RatesControllerTest < ActionController::TestCase
  ...
  test "should create rate" do
    assert_difference('Rate.count') do
      post :create, rate: { product_id: @rate.product_id, rating: @rate.rating, review: @rate.review, user_id: @rate.user_id }
    end
  ...
  test "should update rate" do
    put :update, id: @rate, rate: { product_id: @rate.product_id, rating: @rate.rating, review: @rate.review, user_id: @rate.user_id }
    assert_redirected_to rate_path(assigns(:rate))
  end
